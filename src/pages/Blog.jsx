...
export default function Blog() {
  const defaultPosts = [
  {
    ...
    text: "Building dynamic web applications with the MERN stack has been an incredible learning experience. Each project taught me how to merge frontend design with backend logic seamlessly.",
  },
  {
    id: 2,
    title: "Why I Love AI & Web Development",
    text: "Combining my AI knowledge with full stack development allows me to create smarter applications. I enjoy solving real-world problems through technology and coding.",
  },
  {
    id: 3,
    title: "Balancing Creativity and Logic",
    text: "As a coder, I’ve realized creativity is essential in writing clean, intuitive code. Designing interactive interfaces is like bringing ideas to life with logic and imagination.",
  },
  {
    id: 4,
    title: "The Joy of Learning New Technologies",
    text: "Every new library, framework, or tool opens a door to innovation. Staying curious keeps me motivated to build impactful and efficient solutions.",
  },
];
