...
const ROWS = [
  [
    { title: "Programming Languages", items: ["Basics of Python", "C", "Java"] },
    { title: "Web Technologies", items: ["HTML", "CSS", "JavaScript","Bootstrap", "React"] },
    { title: "Databases & Tools", items: ["MySQL", "MongoDB", "Git", "Github", "Google Colab"] },
