...
const IMAGES = {
  workshops: [
    {
      id: 1,
      caption: "Attending a workshop at MPGI — an amazing experience 🎤",
      photos: ["/gallery/Dev.jpg", "/gallery/dev.png"],
    },
    {
      id: 2,
      caption: "Attending another workshop at IIT-Kanpur 2025 🔥",
      photos: ["/gallery/iitk.png", "/gallery/iitk2.png"],
    },
  ],
  ...
  collegeEvents: [
    {
      id: 1,
      caption: "REETH-2k22 — The best memories of my college life 🎉",
      photos: ["/gallery/reeth4.jpg", "/gallery/Reeth.jpg", "/gallery/reeth1.jpg", "/gallery/reeth3.jpg"],
    },
    {
      id: 2,
      caption: "Winter Gala 2k23 — new beginnings ✨",
      photos: ["/gallery/winter.jpg", "/gallery/winter2.jpg"],
    },
  ],
  ...
  codingPlatforms: [
    {
      id: 1,
      caption: "LeetCode progress — every problem counts 🏆",
      photos: ["/gallery/leet.jpg"],
    },
    {
      id: 2,
      caption: "My GitHub contributions — building, breaking & creating 💻",
      photos: ["/gallery/github.jpg"],
    },
  ],
  ...
  return (
    ...
    >
      ...
      <motion.div className="tab-buttons" variants={childVariants}>
        {["workshops", "collegeEvents", "codingPlatforms","personal"].map(
          (type) => (
            <motion.button
              key={type}
